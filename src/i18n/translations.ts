...
const DICT_EN: Record<string, string> = {
  ...
  "Sütlaç": "Rice Pudding",
  "Hayrabolu": "Hayrabolu (Semolina & Walnut Dessert)",
...
const DICT_AR: Record<string, string> = {
  ...
  "Sütlaç": "أرز باللبن",
  "Hayrabolu": "هايرابولو (حلوى السميد بالجوز)",
  "Pepsi (330ml)": "بيبسي",
...
const DICT_RU: Record<string, string> = {
  ...
  "Hayrabolu": "Хайраболу (десерт из манки с грецким орехом)",
  "Pepsi (330ml)": "Пепси",
...
const DICT_IT: Record<string, string> = {
  ...
  "Hayrabolu": "Hayrabolu (dolce di semolino e noci)",
  "Pepsi (330ml)": "Pepsi (330ml)",
  "Pepsi Max (330ml)": "Pepsi Max (330ml)",
