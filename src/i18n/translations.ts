...
const menuItems = {
  tr: {
    ...
    grills: [
      ...
      { subheading: "Aile Menüleri", name: "Köfteli Aile Menüsü", desc: "Yarım kilo köfte, yarım kilo kanat, yarım kilo tavuk şiş, 4 adet fındık lahmacun, 4 adet içli köfte, 1 L ayran, özel tatlı, çay ve zengin ikramlıklar.", price: "2490 ₺", image: "/menu/kofteli-aile.jpg" },
      { name: "Kebaplı Aile Menüsü", desc: "Yarım kilo kebap, yarım kilo kanat, yarım kilo tavuk şiş, 4 adet fındık lahmacun, 4 adet içli köfte, 1 L ayran, özel tatlı, çay ve zengin ikramlıklar.", price: "2490 ₺", image: "/menu/kebapli-aile.jpg" },
    ],
    // SECTION 5 — Fırın
    firin: [
...
const DICT_EN: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "Large Tray-Size Lahmacun",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "Large tray-size lahmacun on thin dough with minced meat, peppers, tomato and parsley. Contains gluten.",
  "Patates Tava": "Fried Potatoes",
  "Gavurdağı Salatası": "Tomato & Onion Salad",
  "Mercimek Çorbası": "Lentil Soup",
  "Ezogelin Çorbası": "Red Lentil & Bulgur Soup",
  "Antep Yuvalama": "Gaziantep Meatball & Chickpea Soup",
...
const DICT_AR: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "لحم بعجين كبير الحجم",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "لحم بعجين كبير الحجم على عجينة رقيقة مع اللحم المفروم والفلفل والطماطم والبقدونس. يحتوي على الغلوتين.",
  ...
  "Antep Yuvalama": "شوربة عنتاب بكرات اللحم والحمص",
...
const DICT_RU: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "Лахмаджун большого размера",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "Лахмаджун большого размера на тонком тесте с фаршем, перцем, помидорами и петрушкой. Содержит глютен.",
  ...
  "Antep Yuvalama": "Суп из Антепа с фрикадельками и нутом",
...
const DICT_JA: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "特大ラフマジュン",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "薄い生地に挽き肉、ピーマン、トマト、パセリをのせた特大ラフマジュン。グルテンを含みます。",
  "Patates Tava": "フライドポテト",
  "Gavurdağı Salatası": "トマトと玉ねぎのサラダ",
  "Mercimek Çorbası": "レンズ豆スープ",
  "Ezogelin Çorbası": "赤レンズ豆とブルグルのスープ",
  "Antep Yuvalama": "アンテプ風肉団子とひよこ豆のスープ",
...
const DICT_ZH: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "大号拉赫马炯",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "薄饼上铺有肉末、辣椒、番茄和欧芹的大号拉赫马炯。含麸质。",
  "Patates Tava": "炸土豆",
  "Gavurdağı Salatası": "番茄洋葱沙拉",
  "Mercimek Çorbası": "扁豆汤",
  "Ezogelin Çorbası": "红扁豆布格麦汤",
  "Antep Yuvalama": "安泰普肉丸鹰嘴豆汤",
  "Zırh Kebabı": "牛羊肉末烤肉",
...
const DICT_IT: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "Lahmacun formato grande",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "Lahmacun formato grande su pasta sottile con carne macinata, peperoni, pomodoro e prezzemolo. Contiene glutine.",
  ...
  "Antep Yuvalama": "Zuppa di Antep con polpettine e ceci",
...
const DICT_KO: Record<string, string> = {
  ...
  "Tabla Lahmacunu": "대형 라흐마준",
  "İnce hamur üzerine kıyma, biber, domates ve maydanozla hazırlanan büyük boy (tabla) lahmacun. Gluten içerir.": "얇은 반죽 위에 다진 고기, 피망, 토마토, 파슬리를 올린 대형 라흐마준. 글루텐 함유.",
  "Patates Tava": "감자튀김",
  "Gavurdağı Salatası": "토마토 & 양파 샐러드",
  "Mercimek Çorbası": "렌틸 수프",
  "Ezogelin Çorbası": "붉은 렌틸 & 불구르 수프",
  "Antep Yuvalama": "안텝 미트볼 병아리콩 수프",
