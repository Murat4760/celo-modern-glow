...
const menuItems = {
  en: {
    ...
    kebabs: [
      ...
      { name: "Patlıcanlı Kebap (Mevsiminde)", desc: "", price: "900₺" },
    ...
    desserts: [
      ...
      { name: "Havuç Dilim Baklava", desc: "", price: "—" },
      { name: "Katmer", desc: "", price: "290₺" },
      { name: "Tavuk Göğsü", desc: "", price: "—" },
      { name: "Kabak Tatlısı (Mevsiminde)", desc: "", price: "—" },
      { name: "Aşure", desc: "", price: "—" },
      { name: "Dondurma", desc: "", price: "—" },
    ],
    drinks: [
